...
1. [Мини веб-сервер](#1-мини-веб-сервер)
2. [Создание Docker-образа](#2-создание-docker-образа)
3. [Конфигурация nginx](#3-конфигурация-nginx)
4. [Docker Compose](#4-docker-compose)
5. [Проверка безопасности с помощью Dockle](#5-проверка-безопасности-с-помощью-dockle)
...
[Подробнее о мини-сервере](src/Report_DO5.md#3-мини-веб-сервер)
...
[Подробнее о создании Docker-образа](src/Report_DO5.md#4-свой-докер)
...
[Подробнее о Docker Compose](src/Report_DO5.md#6-базовый-docker-compose)
...
[Подробнее о Dockle](src/Report_DO5.md#5-dockle)
