...
- Выполнил команду от имени администратора `sudo` `apt install iperf3`, что бы установить утилиту *ipef3*, на двух машинах.

> Установка утилиты **iperf3**:
>
> ![Установка утилиты iperf3](screen%2Fscreen_3_01.png)
>
